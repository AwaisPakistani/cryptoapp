...
require '../vendor/autoload.php';
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // All moview query    
    $sql_all = "SELECT * FROM users WHERE id='$id' AND verify_token='$verify_token'";
    ...
    if ($result_all->num_rows > 0) {
        ...
        $sql = "UPDATE users SET email_verified_at='$email_verified_at',email_verified_status='1',updated_at='$updated_at' WHERE id='$id'";
